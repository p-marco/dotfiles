const CONFIG = {
  ...
  commands: [
...

    {
      ...
      search: '/search.Search.html?query={}',
...

    {
      ...
      name: 'Kodi',
      key: 'kodi',
      url: 'http://192.168.22.101:8181',
      search: ':8181/#search/all/{}',
      color: 'linear-gradient(135deg, #FF8456, #FF4500)',
      icon: 'fa fa-tv',
      quickLaunch: false,
    },
    {
      ...
      name: 'Calibre',
      key: 'calibre',
      url: 'http://192.168.22.101:8484',
      search: ':8484/search?query={}',
          ...
          return `
            <li class="command">
              <a href="${url}" target="${this._newTab ? '_blank' : '_self'}">
                ...
                <span class="command-key"><i class='${icon}' style="height:1em; background:none !important; filter: invert(100%);"></i></span>
